...
volumes. After a PostgreSQL restart, wait for `/readyz`; after RabbitMQ recovery,
watch Outbox age and queue depth. `make down` keeps development volumes. Automated
verification uses separate disposable projects and does not touch this environment.
